...
local java17_path = os.getenv("HOME") .. "/.sdkman/candidates/java/17.0.18-tem/bin/java"
local ltex_jar = vim.fn.glob(vim.fn.stdpath("data") .. "/mason/packages/ltex-ls/ltex-ls-*.jar")
